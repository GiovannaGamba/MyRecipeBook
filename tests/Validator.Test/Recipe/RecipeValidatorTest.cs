...
namespace Validator.Test.Recipe
{
    public class RecipeValidatorTest
    {
        ...
        [Fact]
        public void Sucess_Cooking_Time_Null()
        {
            var validator = new RecipeValidator();
        ...
        [Fact]
        public void Sucess_Difficulty_Null()
        {
            var validator = new RecipeValidator();
        ...
        public void Error_Same_Step_Instructions()
        {
            ...
            result.IsValid.Should().BeFalse();
            result.Errors.Should().ContainSingle().And.Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.TWO_OR_MORE_INSTRUCTION_SAME_ORDER));
        }
